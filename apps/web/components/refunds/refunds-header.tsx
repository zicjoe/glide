  ...
  return (
    <div className="bg-white border-b border-gray-200 px-8 py-6">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 mb-2">Refunds</h1>
          <p className="text-sm text-gray-600 leading-relaxed max-w-2xl">
            Review refund requests, manage approval flow, track payout status, and monitor reversal records for merchant transactions.
          </p>
        </div>
